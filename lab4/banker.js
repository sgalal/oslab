...
(function(exports) {
  ...
  var readIntVec = function ($57) {
      return Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function ($58) {
          return Data_Maybe.fromMaybe(0)(Data_Int.fromString($58));
      })(Data_String_Common.split(" ")($57)));
  };
  var readIntMat = function ($59) {
      return Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readIntVec)(Data_String_Common.split("\x0a")($59)));
  };
  ...
  var handleProc = function (v) {
      if (v.value0 instanceof Data_List_Types.Nil && v.value1.value0 instanceof Data_List_Types.Nil) {
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(false, new Data_Tuple.Tuple(v, Data_Unit.unit)));
      };
      if (v.value0 instanceof Data_List_Types.Cons && v.value1.value0 instanceof Data_List_Types.Cons) {
          var needV = Data_List.zipWith(Data_Ring.sub(Data_Ring.ringInt))(v.value1.value0.value0)(v.value0.value0);
          var testAllocV = Data_List.zipWith(Data_Ring.sub(Data_Ring.ringInt))(v.value1.value1.value0)(needV);
          var m = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.tr(Control_Apply.applySecond(Control_Monad_Free.freeApply)(Text_Smolder_HTML.td(Text_Smolder_Markup.text("Allocated")))(Text_Smolder_HTML.td(Text_Smolder_Markup.text(printVec(v.value0.value0))))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.tr(Control_Apply.applySecond(Control_Monad_Free.freeApply)(Text_Smolder_HTML.td(Text_Smolder_Markup.text("Maximum")))(Text_Smolder_HTML.td(Text_Smolder_Markup.text(printVec(v.value1.value0.value0))))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.tr(Control_Apply.applySecond(Control_Monad_Free.freeApply)(Text_Smolder_HTML.td(Text_Smolder_Markup.text("Needed (= Maximum - Allocated)")))(Text_Smolder_HTML.td(Text_Smolder_Markup.text(printVec(needV))))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.tr(Control_Apply.applySecond(Control_Monad_Free.freeApply)(Text_Smolder_HTML.td(Text_Smolder_Markup.text("Available")))(Text_Smolder_HTML.td(Text_Smolder_Markup.text(printVec(v.value1.value1.value0))))))(function () {
          ...
          if (canAlloc) {
              var availV$prime = Data_List.zipWith(Data_Semiring.add(Data_Semiring.semiringInt))(v.value0.value0)(v.value1.value1.value0);
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.table(Control_Apply.applySecond(Control_Monad_Free.freeApply)(m)(Text_Smolder_HTML.tr(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.td)(Text_Smolder_HTML_Attributes.colspan("2"))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.className("alloc"))(Text_Smolder_Markup.text("Can allocate.")))))))(function () {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(handleProc(new Data_Tuple.Tuple(v.value0.value1, new Data_Tuple.Tuple(v.value1.value0.value1, new Data_Tuple.Tuple(availV$prime, Data_Unit.unit)))))(function (v1) {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(true, new Data_Tuple.Tuple(v1.value1.value0, Data_Unit.unit)));
                  });
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.table(Control_Apply.applySecond(Control_Monad_Free.freeApply)(m)(Text_Smolder_HTML.tr(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.td)(Text_Smolder_HTML_Attributes.colspan("2"))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.className("unalloc"))(Text_Smolder_Markup.text("Cannot allocate.")))))))(function () {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(handleProc(new Data_Tuple.Tuple(v.value0.value1, new Data_Tuple.Tuple(v.value1.value0.value1, new Data_Tuple.Tuple(v.value1.value1.value0, Data_Unit.unit)))))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(v1.value0, new Data_Tuple.Tuple(new Data_Tuple.Tuple(new Data_List_Types.Cons(v.value0.value0, v1.value1.value0.value0), new Data_Tuple.Tuple(new Data_List_Types.Cons(v.value1.value0.value0, v1.value1.value0.value1.value0), new Data_Tuple.Tuple(v1.value1.value0.value1.value1.value0, Data_Unit.unit))), Data_Unit.unit)));
              });
          });
      };
      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(false, new Data_Tuple.Tuple(v, Data_Unit.unit)));
  ...
  var handleConstr = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.h2(Text_Smolder_Markup.text("Checking for " + printMat(v.value0))))(function () {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(handleProc(v))(function (v1) {
              return Control_Applicative.unless(Control_Monad_Free.freeApplicative)(!v1.value0 || Data_List["null"](v1.value1.value0.value0))(handleConstr(v1.value1.value0));
          });
      });
  };
  var solve = function (allocM) {
      return function (maxiM) {
          return function (availV) {
              return Text_Smolder_Renderer_String.render(handleConstr(new Data_Tuple.Tuple(readIntMat(allocM), new Data_Tuple.Tuple(readIntMat(maxiM), new Data_Tuple.Tuple(readIntVec(availV), Data_Unit.unit)))));
          };
      };
  };
  exports["solve"] = solve;
