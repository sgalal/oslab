...
(function($PS) {
  ...
  var showIntMat = function (xs) {
      return "[" + (Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)(" ")(Data_Functor.map(Data_List_Types.functorList)(showIntVec)(xs)) + "]");
  };
  var readIntVec = (function () {
      var $22 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      var $23 = Data_Functor.map(Data_Functor.functorArray)((function () {
          var $26 = Data_Maybe.fromMaybe(0);
          return function ($27) {
              return $26(Data_Int.fromString($27));
          };
      })());
      var $24 = Data_String_Common.split(" ");
      return function ($25) {
          return $22($23($24($25)));
      };
  })();
  var readIntMat = (function () {
      var $28 = Data_List.fromFoldable(Data_Foldable.foldableArray);
      var $29 = Data_Functor.map(Data_Functor.functorArray)(readIntVec);
      var $30 = Data_String_Common.split("\x0a");
      return function ($31) {
          return $28($29($30($31)));
      };
  })();
      ...
      return function (v1) {
          return function (v2) {
              if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
                  ...
                  var canAlloc = Data_Foldable.all(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (n) {
                      return n >= 0;
                  })(testAllocV);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.h3(Text_Smolder_Markup.text("Checking " + showIntVec(v.value0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.p(Data_Semigroup.append(Control_Monad_Free.semigroupFree(Data_Semigroup.semigroupUnit))(Text_Smolder_HTML.span(Text_Smolder_Markup.text("Maximum:")))(Text_Smolder_HTML.span(Text_Smolder_Markup.text(showIntVec(v1.value0))))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.p(Data_Semigroup.append(Control_Monad_Free.semigroupFree(Data_Semigroup.semigroupUnit))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.title("Maximum - Allocation"))(Text_Smolder_Markup.text("Need:")))(Text_Smolder_HTML.span(Text_Smolder_Markup.text(showIntVec(needV))))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.p(Data_Semigroup.append(Control_Monad_Free.semigroupFree(Data_Semigroup.semigroupUnit))(Text_Smolder_HTML.span(Text_Smolder_Markup.text("Available:")))(Text_Smolder_HTML.span(Text_Smolder_Markup.text(showIntVec(v2))))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.p(Data_Semigroup.append(Control_Monad_Free.semigroupFree(Data_Semigroup.semigroupUnit))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.title("Available - Need"))(Text_Smolder_Markup.text("Test Allocate:")))(Text_Smolder_HTML.span(Text_Smolder_Markup.text(showIntVec(testAllocV))))))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)((function () {
                                          if (canAlloc) {
                                              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.p)(Text_Smolder_HTML_Attributes.className("alloc"))(Text_Smolder_Markup.text("Can allocate."));
                                          };
                                          return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.p)(Text_Smolder_HTML_Attributes.className("unalloc"))(Text_Smolder_Markup.text("Cannot allocate."));
                                      })())(function () {
                                          if (canAlloc) {
  ...
  var handleConstr = function (allocM) {
      return function (maxiM) {
          return function (availV) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.h2(Text_Smolder_Markup.text("Checking " + showIntMat(allocM))))(function () {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(handleProc(allocM)(maxiM)(availV))(function (v) {
                      ...
                      throw new Error("Failed pattern match at Main (line 56, column 3 - line 59, column 38): " + [ v.value0.constructor.name, v1.constructor.name ]);
                  });
              });
          };
      };
