...
(function(exports) {
  ...
  var retrieve_aux = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 19, column 1 - line 19, column 56: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var retrieve = function (p) {
      return function ($54) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(retrieve_aux(p)(Data_List.fromFoldable(Data_Foldable.foldableArray)($54)));
      };
  };
  ...
  var allocate_aux = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 9, column 1 - line 9, column 63: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var allocate = function (p) {
      return function (l) {
          return function ($55) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(allocate_aux(p)(l)(Data_List.fromFoldable(Data_Foldable.foldableArray)($55)));
          };
      };
  };
  exports["Idle"] = Idle;
